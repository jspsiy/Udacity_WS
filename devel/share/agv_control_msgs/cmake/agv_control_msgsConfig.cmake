...
if("TRUE" STREQUAL "TRUE")
  set(agv_control_msgs_SOURCE_PREFIX /home/joshua/capstone_ws/src/agv_control_msgs)
  set(agv_control_msgs_DEVEL_PREFIX /home/joshua/capstone_ws/devel)
  ...
  set(agv_control_msgs_INSTALL_PREFIX /home/joshua/capstone_ws/install)
...
if(NOT "/home/joshua/capstone_ws/devel/include " STREQUAL " ")
  set(agv_control_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/joshua/capstone_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'agv_control_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joshua/capstone_ws/src/agv_control_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT agv_control_msgs_NUM_DUMMY_TARGETS)
      set(agv_control_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::agv_control_msgs::wrapped-linker-option${agv_control_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR agv_control_msgs_NUM_DUMMY_TARGETS "${agv_control_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::agv_control_msgs::wrapped-linker-option${agv_control_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND agv_control_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/joshua/capstone_ws/devel/lib;/home/joshua/capstone_ws/devel/lib;/home/joshua/mil_ws/devel/lib;/opt/ros/melodic/lib)
