...
public:
    ...
    //referenced from https://en.cppreference.com/w/cpp/language/rule_of_three 8PM 5/1/2020 because i have terrible memory on how the rule of 5 structure looks like
    ////
    //// EOF STUDENT CODE
